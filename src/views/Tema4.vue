  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    .row.align-items-center(data-aos="fade-left").justify-content-center
      .col-12.col-md-12.col-lg-12
        ...
        .titulo-segundo.color-acento-contenido(data-aos="fade-right")
          h2#t_4_1 4.1 Introducción y principios de las metodologías ágiles 
          ...
          .col-12.col-md-12.col-lg-9
            .row.justify-content-center.align-items-center.mb-4
              ...
              .col-lg-7.col-md-12.bg-color-primario-p20(order-sm="1" order-md="1").p-5
                p.mb-0(data-aos="fade-right") Las metodologías ágiles surgen como una respuesta crítica a la rigidez, linealidad y tiempos extensos que suelen presentarse en modelos tradicionales de gestión de proyectos, los cuales se centran en una planificación exhaustiva previa y en la ejecución secuencial de tareas.
            ...
            .row.justify-content-center.align-items-center
              .col-12.col-md-12.col-lg-12.bg-color-1.p-3.mb-3
                .row.justify-content-center
                  ...
                  .col-lg
                    p.mb-0(data-aos="fade-right") Frente a estos esquemas, las metodologías ágiles se enfocan en la flexibilidad, la colaboración continua, la adaptabilidad al cambio y la entrega constante de valor, fomentando entornos de trabajo donde la incertidumbre se gestiona de forma iterativa y el aprendizaje se convierte en un proceso permanente.
          ...
          .col-lg-8.order-lg-1
            SlyderF(columnas="col-12 col-lg-6").p-4
              ...
              .bg-color-white.p-4.h-100.box-shadow
                ...
                h4.text-center.mb-4 Iteración y aprendizaje continuo
                p.text-center A través de los hallazgos parciales que retroalimentan el diseño del estudio o la intervención, permitiendo reajustar hipótesis, métodos o productos.
      ...
      .col-12.col-md-12.col-lg-12
        ...
        .row.justify-content-center.align-items-center.z-2.mb-4
          .col-lg-9(data-aos="fade-up")
            p.banner-text La metodología Lean Startup, propuesta por Ries (2011), fusiona principios ágiles y enfoques de validación científica para gestionar la innovación en contextos de alta incertidumbre. Su objetivo es minimizar el desperdicio de recursos y maximizar el aprendizaje validado, mediante ciclos iterativos de experimentación rápida. En el entorno de la investigación en salud pública, Lean Startup ayuda a probar intervenciones, herramientas o tecnologías de salud (por ejemplo, una app de monitoreo epidemiológico) de manera escalonada, antes de comprometer grandes recursos o desplegar a gran escala.
          ...
          .col-12.col-md-12.col-lg-10
            ...
            .row.align-items-center.justify-content-center.mb-5
              .col-md-8.col-lg-4.mb-3.mb-lg-0
                figure
                  img(src="@/assets/curso/temas/tema4/img15.png", data-aos="zoom-in")
              .col-lg-8
            ...
            .row.mb-5.justify-content-center.align-items-center
              ...
              .col-lg
                p.mb-0(data-aos="fade-right") De acuerdo con lo establecido por la organización Solvingadhoc (2017), en el enfoque Lean Startup, la validación de hipótesis constituye un proceso sistemático orientado a comprobar empíricamente los supuestos más críticos de un proyecto, especialmente aquellos que sustentan su pertinencia, viabilidad y potencial de impacto. En el contexto de la investigación en salud pública, se busca determinar, por ejemplo, si un producto o servicio será adoptado, si la intervención, herramienta o tecnología propuesta genera valor real para la población objetivo, si contribuye a resolver un problema de salud o si puede sostenerse en el tiempo dentro del sistema de salud.
        ...
        .row.mb-5.justify-content-center.align-items-center
          .col-12.col-md-12.col-lg-10
            ...
            .row.align-items-center.bg-color-2.p-4(data-aos="fade-left").icono-inferior.mb-4
      ...
      .col-12.col-md-12.col-lg-10
        ...
        .row.justify-content-center.align-items-center.mb-4
          ...
          .col-xl-3
            ...
            p.mb-0 En estos contextos, Scrum permite integrar de manera efectiva a equipos multidisciplinarios, como científicos, epidemiólogos, analistas de datos, ingenieros biomédicos y gestores, promoviendo la coordinación, la transparencia y la mejora continua en cada ciclo de trabajo.
        ...
        .row.align-items-center.bg-color-terciario-t5.p-4(data-aos="fade-left").icono-inferior.mb-4
          ...
          .col-12.col-md-12.col-lg-8.mb-4.mb-lg-0
            p.mb-0 En instituciones de salud o investigación, la implementación de Scrum ayuda a organizar proyectos en fases iterativas denominadas sprints, donde los equipos producen entregables parciales, revisan resultados y adaptan sus estrategias con base en la evidencia emergente. Esta metodología es especialmente valiosa en entornos caracterizados por alta incertidumbre y múltiples dependencias entre disciplinas, como ocurre en estudios de vigilancia epidemiológica, desarrollo de herramientas tecnológicas, validación de intervenciones o implementación de sistemas de información en salud (Schwaber & Sutherland, 2020).

        .row.align-items-center.justify-content-center.mb-3
          p.mb-0 El marco Scrum se estructura en torno a tres roles fundamentales, que pueden adaptarse a los entornos institucionales y científicos sin perder su esencia colaborativa:
          ...
          SlyderA(tipo="b").bg-color-white.p-4.tarjeta
            ...
            .row.justify-content-center.align-items-center
              .col-lg-8.mb-4.mb-md-0
                ...
                p.mb-0 Son el equipo de trabajo en los proyectos de investigación y salud pública este equipo puede estar conformado por investigadores de distintas áreas, epidemiólogos, bioestadísticos, tecnólogos, analistas de laboratorio, profesionales de salud, programadores o diseñadores. Su tarea es ejecutar las actividades planificadas dentro de cada sprint, desarrollar los productos intermedios, por ejemplo, protocolos, bases de datos depuradas, informes de resultados parciales o prototipos tecnológicos, y validar los avances obtenidos. Lo esencial es que el equipo sea autónomo, multidisciplinario y comprometido con los resultados colectivos, ya que la efectividad del Scrum depende de la capacidad del grupo para autoorganizarse y mantener una comunicación constante (Schwaber & Sutherland, 2020).
              .col-lg-4.mb-3.mb-lg-0
                figure
      ...
      .row.justify-content-center.align-items-center
        .col-12.col-md-12.col-lg-10
          .row.mb-5.justify-content-center.align-items-center
            ...
            .col-lg
              p.mb-0(data-aos="fade-right") Según lo establecido por Schwaber & Sutherland (2020), el ciclo de Scrum se compone de eventos iterativos y artefactos documentales que estructuran el trabajo del equipo, garantizando la visibilidad de los avances y la mejora continua en cada iteración.
          
          .row.mb-5.justify-content-center.align-items-center
            h4.mb-3 Eventos principales:
            .col-lg-12.order-lg-1
              TabsA.color-acento-botones
                .tarjeta.color-acento-botones--borde.p-4(titulo="Ciclo de trabajo (Sprint)")
                  p.mb-0 Es el corazón de Scrum, consiste en un ciclo de trabajo corto, generalmente entre una y cuatro semanas, en el que se define un objetivo específico y se generan entregables concretos. En investigación en salud, un sprint puede enfocarse en una tarea específica como el diseño de un instrumento de recolección de datos, la limpieza de una base de datos epidemiológica, la validación de un algoritmo o el desarrollo de un módulo de visualización. Cada sprint debe concluir con un producto parcial funcional que aporte valor y que pueda ser revisado y mejorado.
                .tarjeta.color-acento-botones--borde.p-4(titulo="Reunión de seguimiento")
                ...
                .tarjeta.color-acento-botones--borde.p-4(titulo="Revisión del ciclo")
                ...
                .tarjeta.color-acento-botones--borde.p-4(titulo="Retrospectiva")
      ...
      .row.justify-content-center.mb-5(data-aos="fade-right")
        ...
        .col-12.col-md-6.col-lg-4
          .bg-color-terciario-t10.p-4.h-100.border-radius-20
            ...
            p.text-center Conjunto de tareas específicas seleccionadas, son aquellas tareas que deben completarse en el sprint o ciclo actual.
        ...
        .col-12.col-md-6.col-lg-4
          .bg-color-primario-p20.p-4.h-100.border-radius-20
            ...
            p.text-center Es el resultado tangible del sprint, es decir, el producto científico o técnico entregable, como un informe de avance, un prototipo de sistema o un análisis estadístico preliminar, que contribuye al objetivo general del proyecto.
        ...
        .col-12.col-md-12.col-lg-10     
          .row.justify-content-center.align-items-center
            ...
            .col-lg-7.mb-4.mb-md-0
              p.mb-3 De acuerdo con Rojas (2022), la adaptación de Scrum a entornos de investigación fomenta la transparencia, la trazabilidad de los avances y la eficiencia operativa, especialmente cuando se combina con otros marcos como Kanban. Esta integración permite documentar de forma continua los hitos, reducir los cuellos de botella en los flujos de trabajo y fortalecer la cohesión del equipo alrededor de objetivos comunes.
    ...
    .row.align-items-center(data-aos="fade-left").justify-content-center
      .col-12.col-md-12.col-lg-12
        ...
        .bloque-texto-g.bg-acento-contenido.p-3.p-sm-4.p-md-5.mb-5
          .bloque-texto-g__img(
            :style="{'background-image': `url(${require('@/assets/curso/temas/tema4/img35.png')})`}"
          )
          .bloque-texto-g__texto.p-4
            p.mb-0 El método Kanban es un sistema de gestión visual orientado a optimizar el flujo de trabajo, mejorar la comunicación y aumentar la eficiencia operativa dentro de los equipos y organizaciones. Su origen se remonta al modelo de producción de Toyota, donde se utilizaba para controlar los niveles de inventario y sincronizar los procesos industriales. Con el tiempo, este enfoque fue adaptado con éxito a los ámbitos de los servicios, la salud y la investigación, demostrando su utilidad para coordinar equipos interdisciplinarios, reducir tiempos de espera y mejorar la organización de las tareas.
        ...
        .row.align-items-center.justify-content-center(data-aos="fade-right")
          .row.mb-5.justify-content-center.align-items-center
            ...
            .col-lg-8.col-md-12.mb-4.mb-md-0(order-sm="1" order-md="1")
              ...
              p.mb-0(data-aos="fade-right") Los principios básicos de Kanban pueden resumirse en cuatro aspectos centrales:
          ...
          .col-lg-8.order-lg-1
            SlyderF(columnas="col-12 col-lg-6").p-4
              .bg-color-white.p-4.h-100.box-shadow
                ...
                p.text-center Mostrar de manera clara todas las actividades y su estado actual, para comprender el proceso en su conjunto y promover la colaboración.

              .bg-color-white.p-4.h-100.box-shadow
                img(src='@/assets/curso/temas/tema4/img38.svg' alt='AvatarTop' , style="max-width: 90px").mx-auto.mb-3
                h4.text-center.mb-4 Limitar el trabajo en curso
                p.text-center Establecer un número máximo de tareas que pueden desarrollarse simultáneamente, evitando la dispersión y la sobrecarga del equipo.

              .bg-color-white.p-4.h-100.box-shadow
                img(src='@/assets/curso/temas/tema4/img39.svg' alt='AvatarTop' , style="max-width: 90px").mx-auto.mb-3
                h4.text-center.mb-4 Gestionar el flujo y priorizar por valor
                p.text-center Enfocar los esfuerzos en las tareas que aportan mayor impacto al objetivo del proyecto, asegurando la continuidad y el equilibrio entre las etapas.

              .bg-color-white.p-4.h-100.box-shadow
                img(src='@/assets/curso/temas/tema4/img40.svg' alt='AvatarTop' , style="max-width: 90px").mx-auto.mb-3
                h4.text-center.mb-4 Revisar y mejorar de manera continua
    ...
    .row.align-items-center.justify-content-center.mb-4(data-aos="fade-right")
      .col-12.col-md-12.col-lg-10
        .row.align-items-center.bg-color-primario-p20.p-4(data-aos="fade-left").icono-inferior
          ...
          .col-12.col-md-12.col-lg-9.mb-4.mb-lg-0
            p.mb-0 De acuerdo con Martins (2025), la implementación de Kanban no requiere herramientas tecnológicas complejas, sino una estructura clara y el compromiso del equipo con la transparencia y la organización del trabajo. En proyectos de investigación, los tableros Kanban pueden utilizarse para planificar y monitorear el avance de los objetivos específicos, desde la formulación del proyecto hasta la publicación de los resultados.
      ...
      .col-12.col-md-12.col-lg-10
        .row.justify-content-center.align-items-center.mb-4
          .col-lg-8.col-xl-6.mb-3.mb-lg-0
            .bg-color-5.p-5.px-lg-4.tarjeta 
              p.mb-0 En instituciones de salud, los tableros Kanban se han utilizado para mejorar la coordinación de equipos clínicos, gestionar proyectos de innovación o monitorear procesos administrativos y de calidad. Mejía (2024) señala que la aplicación de este método en hospitales permite reducir desperdicios, optimizar la utilización de recursos humanos y materiales, y mejorar la capacidad de respuesta ante cambios o demandas emergentes. En este sentido, Kanban no solo organiza las tareas, sino que promueve una cultura de trabajo basada en la evidencia y en la mejora continua.
          .col-xl-6
            .row.justify-content-center.align-items-center.mb-4
              .col-auto.mb-3.mb-lg-0
                figure
              ...
              .col-lg
                p.mb-0(data-aos="fade-right") Además, su versatilidad facilita la integración con otras metodologías ágiles como Scrum o Lean, permitiendo que los equipos adapten su gestión de acuerdo con la naturaleza del proyecto

            p.mb-0 Mientras Scrum estructura el trabajo en ciclos de tiempo definidos, Kanban ofrece una visión continua del flujo de tareas, ideal para procesos en marcha o de larga duración, como los que suelen presentarse en la investigación en salud pública
      ...
      .col-12.col-md-12.col-lg-10
        .row.align-items-center.bg-color-1.p-4
          .col-lg-auto
            img.d-lg-flex.d-none(src="@/assets/curso/temas/tema4/img20.svg", style="max-width: 100px").mx-auto
          .col-lg.p-lg-4
            p.mb-0 En resumen, Kanban aporta una estructura visual, flexible y participativa para la gestión de proyectos de investigación y programas de salud. Su aplicación fortalece la eficiencia, la comunicación y la toma de decisiones, contribuyendo a que los equipos trabajen de forma más coordinada, transparente y orientada al logro de resultados sostenibles.
    ...
    .row.align-items-center(data-aos="fade-left").justify-content-center
      .col-12.col-md-12.col-lg-10
        //- Titulo
        .titulo-segundo.color-acento-contenido(data-aos="fade-right")
          h2#t_4_5 4.5 Comparación y selección de la metodología ágil
      ...
      .row.align-items-center.justify-content-center.mb-5(data-aos="fade-right")
        .col-12.col-md-12.col-lg-10
          .row.align-items-center
            ...
            .col-lg.p-lg-4
              p.mb-0 La selección de las metodologías debe basarse en el nivel de incertidumbre, el tamaño del equipo y el tipo de entrega. En contextos de investigación en salud pública, se recomienda un enfoque híbrido, combinando Scrum para gestión iterativa, Kanban para control de flujo y Lean Startup para validación científica (ver Tabla 4).
      ...
      .row.justify-content-center.align-items-center(data-aos="fade-left").mb-5
        .col-lg-12
          .bloque-texto-g.bg-color-primario.p-3.p-sm-4.p-md-5
            .bloque-texto-g__img(
              :style="{'background-image': `url(${require('@/assets/curso/temas/tema4/img46.png')})`}"
            )
            .bloque-texto-g__texto.p-4
              p.mb-0 La selección de la metodología ágil más adecuada depende del contexto y de las condiciones del proyecto. En investigaciones o programas con alta incertidumbre o componentes innovadores, Lean Startup resulta particularmente útil para validar hipótesis tempranas y reducir el riesgo antes de invertir en desarrollos de mayor escala. Cuando el proyecto requiere una gestión estructurada y colaborativa de múltiples actores o disciplinas, Scrum ofrece una forma efectiva de coordinar tareas y fomentar la revisión continua. Por su parte, Kanban es ideal para contextos donde se necesita una visión general del flujo de trabajo, manteniendo el control operativo y optimizando los recursos en tiempo real.
