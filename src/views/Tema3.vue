        ...
        .row.justify-content-center.align-items-center.mb-5
          .col-lg-5.col-xl-3.mb-3.mb-lg-0
            .bg-color-5.p-4.px-lg-4.tarjeta 
              p.mb-0 El producto mínimo viable (MVP) es un prototipo que permite comprobar si el bien o servicio que está desarrollando una compañía se ajusta a las necesidades del mercado y, de no hacerlo, los cambios que debe introducir en su diseño, funcionalidad o, incluso, precio.
